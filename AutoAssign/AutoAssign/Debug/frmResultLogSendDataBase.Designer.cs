...
{
    partial class frmResultLogSendDataBase
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBox1.Text = "结果读取日志是否存储至数据库";
            ...
            this.Name = "frmResultLogSendDataBase";
            this.Text = "结果读取日志是否存储至数据库";
            this.Load += new System.EventHandler(this.frmScannerLogSendDataBase_Load);
