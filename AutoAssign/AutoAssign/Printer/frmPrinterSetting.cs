...
namespace AutoAssign.Printer
{
    public partial class frmPrinterSetting : Common.frmBase
    {
        ...
        private void frmPrinterSetting_Load(object sender, EventArgs e)
        {
            ...
            {
                if (string.Compare(AutoAssign.MyPrinter.PrinterMachineName, printer, true) == 0)
                {
        ...
        private void btTrue_Click(object sender, EventArgs e)
        {
            ...
            AutoAssign.MyPrinter.PrinterMachineName = this.comQyPrinters.Text;
            ...
            try
            {
                Common.CommonFuns.ConfigINI.SetValue("Printer", "PrintMachineName", AutoAssign.MyPrinter.PrinterMachineName);
                Common.CommonFuns.ConfigINI.SetValue("Printer", "AutoPrintTuoPan", AutoAssign.MyPrinter.AutoPrint ? "1" : "0");
                Common.CommonFuns.ConfigINI.SetValue("Printer", "QRSet_Left", AutoAssign.MyPrinter.QRSet_Left.ToString());
                Common.CommonFuns.ConfigINI.SetValue("Printer", "QRSet_Top", AutoAssign.MyPrinter.QRSet_Top.ToString());
                Common.CommonFuns.ConfigINI.SetValue("Printer", "WordsSet_Left", AutoAssign.MyPrinter.WordsSet_Left.ToString());
                Common.CommonFuns.ConfigINI.SetValue("Printer", "WordsSet_Top", AutoAssign.MyPrinter.WordsSet_Top.ToString());
                Common.CommonFuns.ConfigINI.SetValue("Printer", "QRSize", AutoAssign.MyPrinter.QRSize.ToString());
