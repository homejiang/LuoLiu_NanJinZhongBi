...
namespace LuoLiuDianHan
{
    public partial class frmStationConfig : Common.frmBase
    {
        ...
        private void frmStationConfig_Load(object sender, EventArgs e)
        {
            ...
            if (!this.BindMac(Config.MacCode))
                this._MacCode = string.Empty;
            else this._MacCode = Config.MacCode;
        }
        ...
        private void btTrue_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Common.CommonFuns.ConfigINI.SetValue("Station", "MacCode", Config.MacCode);
            }
            catch (Exception ex)
            {
