...
namespace BasicData
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #endregion
            if (Common.CommonDAL.MainProgramName == "" || string.Compare(Common.CommonDAL.MainProgramName, "BasicData.exe", true) == 0)
        ...
        static void StartPro()
        {
            ...
            frmlogin1.Tag = "BasicData.exe-" + Common.CommonDAL.StartArg;
