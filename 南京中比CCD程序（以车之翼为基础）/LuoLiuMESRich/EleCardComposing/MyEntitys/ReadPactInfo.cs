...
namespace EleCardComposing.MyEntitys
{
    #region 相关类及委托
    ...
    public class ReadPactInfo
    {
        ...
        public EleCardComposing.frmMain MyForm = null;
        ...
        public string ReadFromRemoteDB(string sPlanGuid,string sStation, out string sErrMsg)
        {
            ...
            try
            {
                dt = Common.CommonDAL.DoSqlCommand.GetDateTable(string.Format("EXEC EleCardComposing_GetPactInfo '{0}','{1}'"
