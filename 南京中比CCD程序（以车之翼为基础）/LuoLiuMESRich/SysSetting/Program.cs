...
namespace SysSetting
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #endregion
            if (Common.CommonDAL.MainProgramName == "" || string.Compare(Common.CommonDAL.MainProgramName, "SysSetting.exe", true) == 0)
        ...
        static void StartPro()
        {
            ...
            frmlogin1.Tag = "SysSetting.exe-" + Common.CommonDAL.StartArg;
            Application.Run(frmlogin1);
            if (frmlogin1.DialogResult == DialogResult.OK)
            {
                Application.Run(new Form2());
                //Application.Run(new SysSetting.BanCi.frmBanCi());
            }
        }
    }
    #region 读取版本信息
