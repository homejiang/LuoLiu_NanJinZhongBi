...
namespace LuoLiuMESPrinter
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (Common.CommonDAL.MainProgramName == "" || string.Compare(Common.CommonDAL.MainProgramName, "LuoLiuMESPrinter.exe", true) == 0)
            ...
            if (!Common.CommonFuns.OneInstance.IsFirst("hangzhouchenhenLuoliuMesPrinterDevelopeByJiangPengsong"))
            {
            ...
            if (JpsConfig.ProcessCode.Length == 0 || JpsConfig.StationCode.Length == 0)
            {
            ...
            frmlogin1.Tag = "LuoLiuMESPrinter.exe-" + Common.CommonDAL.StartArg;
