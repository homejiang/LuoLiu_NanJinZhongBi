...
namespace LuoLiuMESPrinter.Setting
{
    public partial class frmPrinterSetting : Common.frmBase
    {
        ...
        {
            this.checkBox1.Checked = LuoLiuMESPrinter.MyPrinter.AutoPrint;
            int iSeled = -1;
            foreach (string printer in System.Drawing.Printing.PrinterSettings.InstalledPrinters)
            {
                if (string.Compare(LuoLiuMESPrinter.MyPrinter.PrinterMachineName, printer, true) == 0)
                {
        ...
        {
            LuoLiuMESPrinter.MyPrinter.AutoPrint = this.checkBox1.Checked;
            ...
            LuoLiuMESPrinter.MyPrinter.PrinterMachineName = this.comQyPrinters.Text;
            ...
            try
            {
                Common.CommonFuns.ConfigINI.SetValue("Printer", "PrintMachineName", LuoLiuMESPrinter.MyPrinter.PrinterMachineName);
                Common.CommonFuns.ConfigINI.SetValue("Printer", "AutoPrintTuoPan", LuoLiuMESPrinter.MyPrinter.AutoPrint ? "1" : "0");
                Common.CommonFuns.ConfigINI.SetValue("Printer", "QRSet_Left", LuoLiuMESPrinter.MyPrinter.QRSet_Left.ToString());
                Common.CommonFuns.ConfigINI.SetValue("Printer", "QRSet_Top", LuoLiuMESPrinter.MyPrinter.QRSet_Top.ToString());
                Common.CommonFuns.ConfigINI.SetValue("Printer", "WordsSet_Left", LuoLiuMESPrinter.MyPrinter.WordsSet_Left.ToString());
                Common.CommonFuns.ConfigINI.SetValue("Printer", "WordsSet_Top", LuoLiuMESPrinter.MyPrinter.WordsSet_Top.ToString());
                Common.CommonFuns.ConfigINI.SetValue("Printer", "QRSize", LuoLiuMESPrinter.MyPrinter.QRSize.ToString());
                Common.CommonFuns.ConfigINI.SetValue("Printer", "FontSize", this.numFontSize.Value.ToString("#########0.##"));
                Common.CommonFuns.ConfigINI.SetValue("Printer", "WordsRN", LuoLiuMESPrinter.MyPrinter.WordsRN.ToString());
            }
            catch (Exception ex)
            {
